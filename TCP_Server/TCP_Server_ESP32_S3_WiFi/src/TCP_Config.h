...
IPAddress tcpServerIP(192, 168, 2, 110); // IP-Adresse TCP-Server (siehe ZUSI)
...
#define PORT 1436 // siehe ZUSI

WiFiClient client; // Betriebsart WiFi.h als Client

/***TCP-Zustände***/
short tcp_zustand;
#define TCP_VERBINDE 0
#define TCP_SENDE_KONFIGURATION 1
#define TCP_WARTE_AUF_KONFIGURATION 2
#define TCP_SENDE_KONFIGURATION_ENDE 3
#define TCP_EMPFANGE_DATEN 4
#define TCP_WERTE_DATEN_AUS 5
