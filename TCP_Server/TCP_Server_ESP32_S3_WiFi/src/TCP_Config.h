...
#define TUER_RECHTS 1
#define TUER_LINKS 2
#define FEDERSPREICHER 3

/***WiFi.h***/
const char* ssid = "devolo-bcf2afac0c61";
const char* passwort = "ZVAVCVUQBDSPDCYV";

IPAddress tcpServerIP (192, 168, 2, 170); // IP-Adresse TCP-Server
...
/***TCP-Zustände***/
#define TCP_SENDE_TEST_NACHRICHT 0
#define TCP_SENDE_KONFIGURATION 1
#define TCP_EMPFANGE_DATEN 2
#define TCP_WERTE_DATEN_AUS 3
